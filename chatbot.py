...
#----Additional Google Sheet Function
import gspread
from oauth2client.service_account import ServiceAccountCredentials
scope = ["https://spreadsheets.google.com/feeds",'https://www.googleapis.com/auth/spreadsheets',"https://www.googleapis.com/auth/drive.file","https://www.googleapis.com/auth/drive"]
cerds = ServiceAccountCredentials.from_json_keyfile_name("creds-api-googlesheet.json", scope)

Client = gspread.authorize(cerds)
sheet = Client.open("Chatbot-Foodd").worksheet("Sheet1")
#----Additional Firebase Function----
from random import randint
import firebase_admin
from firebase_admin import credentials
from firebase_admin import firestore
cred = credentials.Certificate("./fooddbot-firebase-adminsdk-4ma4h-46ec20e8dd.json")
